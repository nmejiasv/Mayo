...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController : Controller
    {
        ...
        public ActionResult ExcelReporte()
        {
            return View();
        }
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var fechaFin = DateTime.Today.AddYears(0000);
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            ...
            var nombreArhivo = $"Manejo Presupuestos - {DateTime.Today.ToString("dd-MM-yyy")}.xlsx";
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    return File(stream.ToArray(),
                        "application/vnd.openxmlformats-officedocument.sheadsheetml.sheet",
                        nombreArchivo);
                }
            }
        }
